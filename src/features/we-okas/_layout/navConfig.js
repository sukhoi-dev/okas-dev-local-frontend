...
const weOkasNav = [
  ...
  { key: 'users',         label: 'Users',              path: ROUTE_PATHS.WEOKAS_USERS,         icon: PeopleIcon,                permission: P.USERS_VIEW         },
  { key: 'organizations', label: 'Organizations',      path: ROUTE_PATHS.WEOKAS_ORGANIZATIONS, icon: ApartmentIcon,             permission: P.ORGS_VIEW          },
  { key: 'roles',         label: 'Roles & Permissions',path: ROUTE_PATHS.WEOKAS_ROLES,         icon: AdminPanelSettingsIcon,    permission: P.ROLES_VIEW         },
