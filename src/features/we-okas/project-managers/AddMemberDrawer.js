            ...
            <div className="bg-white rounded-[4px] w-full border border-[#e2e2e2]">
              <div className="flex flex-col gap-[20px] items-start px-[24px] py-[28px]">
                ...
                <div className="flex flex-col gap-[8px] w-full">
                  ...
                  <div className="relative w-full">
                    <select value={formData.role} onChange={(e) => setFormData({ ...formData, role: e.target.value })} className="bg-[#f4f7fb] h-[48px] w-full rounded-[4px] px-[16px] pr-[48px] font-['Inter:Regular',sans-serif] text-[15px] text-[#0a1e3f] outline-none focus:ring-2 focus:ring-[#0a1e3f]/10 appearance-none cursor-pointer">
        ...
        <div className="shrink-0">
          ...
          <div className="bg-white w-full">
            ...
            <div className="flex items-center justify-end px-[28px] py-[16px] gap-[8px]">
              <button onClick={() => { reset(); onClose(); }} className="flex h-[48px] items-center justify-center px-[24px] rounded-[4px] hover:bg-[#f4f7fb] transition-colors">
                <p className="font-['Inter:Medium',sans-serif] font-medium text-[#5c7089] text-[15px]">Cancel</p>
              </button>
              <button onClick={handleSubmit} className="bg-[#0a1e3f] flex h-[48px] items-center justify-center px-[32px] rounded-[4px] w-[140px] hover:opacity-90 transition-opacity">
